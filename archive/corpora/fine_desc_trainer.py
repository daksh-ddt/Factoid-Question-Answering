...
train_DESC = load_files('DESC/',  categories=categories,  shuffle=True,  random_state=42)

# save train_DESC pickle
filehandler = open('pickle_training_DESC.pkl', 'wb') 
pickle.dump(train_DESC,  filehandler)
filehandler.close()
...
filehandler = open('pickle_clf_DESC.pkl', 'wb') 
